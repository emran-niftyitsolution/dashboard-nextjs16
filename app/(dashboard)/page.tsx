    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between">
        ...
        <div className="mt-4 md:mt-0">
          <select className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400">
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <div className="flex items-center gap-1">
                  {stat.isPositive ? (
                    <FiArrowUp className="text-green-500 dark:text-green-400 text-sm" />
                  ) : (
                    <FiArrowDown className="text-red-500 dark:text-red-400 text-sm" />
                  )}
                  <span
                    className={cn(
                      "text-sm font-medium",
