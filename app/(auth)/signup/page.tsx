    ...
    <div className="flex min-h-screen bg-white transition-colors dark:bg-gray-900">
      ...
      <div className="relative hidden overflow-hidden bg-gray-100 lg:flex lg:w-1/2 dark:bg-gray-800">
        ...
        <div className="relative z-10 flex flex-col items-start justify-center px-16 text-white">
          <h1 className="mb-6 text-5xl font-bold">Start Your Journey</h1>
          <p className="mb-8 max-w-md text-xl text-purple-100">
          ...
          <div className="mt-12 grid grid-cols-3 gap-8">
            ...
            <div>
              <div className="mb-1 text-4xl font-bold">98%</div>
              <div className="text-sm text-purple-200">Satisfaction</div>
            </div>
            <div>
              <div className="mb-1 text-4xl font-bold">4.9</div>
